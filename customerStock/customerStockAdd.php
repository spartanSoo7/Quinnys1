...
<div id = "centerTitle">
    <h2>Add Customer Stock Level: </h2>
</div>


    <table class = "updateTable2">
        <form id="FormName" action="customerStockAdded.php" method="post" name="FormName">
            <tr>
                <th></th>
...
ORDER BY STOCK_TYPE_NAME ASC, STOCK_NAME ASC
        ...
        <tr>
            <th>
                    <label for="TOTAL_QUANTITY_NEEDED">Hold level Total: </label>
            </th>
            <td>
                <input id="TOTAL_QUANTITY_NEEDED" name="TOTAL_QUANTITY_NEEDED" style="width: 100%;" type="number" value="" maxlength="9" minlength="1" required/>
            </td>
        </tr>

        <tr style="border-bottom: 0px; ">
            <td colspan="2" style="text-align: center">
                <input type="submit" id="submit" name="submitButtonName" value="Add stock level"/>
            </td>
        </tr>
    </table>
</form>
