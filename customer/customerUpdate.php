...
?>
    ...
    <table class = "updateTable" border='0' align='center' width='50%'>
        ...
        <tr>
            <td width="150">
                <div align="left">
                    <label for="CUSTOMER_EMAIL">Customer Email Address</label></div>
            </td>
            <td>
        ...
        <tr>
            <td width="150">
                <div align="left">
                    <label for="CUSTOMER_PHONE1">Customer Primary Phone Number</label></div>
            </td>
            <td>
        ...
        <tr>
            <td width="150">
                <div align="left">
                    <label for="CUSTOMER_PHONE2">Customer Secondary Phone Number</label></div>
            </td>
            <td>
        ...
        <tr>
            <td width="150">
                <div align="left">
                    <label for="CUSTOMER_POSTAL_ADDRESS">Customer Postal Address</label></div>
            </td>
            <td>
        ...
        <tr>
            <td width="150">
                <div align="left">
                    <label for="CUSTOMER_PHYSICAL_ADDRESS">Customer Physical Address</label></div>
            </td>
            <td>
        ...
        <tr>
            <td width="150">
                <div align="left">
                    <label for="CUSTOMER_CONTACT_NAME">Customer Contact Name</label></div>
            </td>
            <td>
        ...
        <tr>
            <td width="150"></td>
            <td><input type="submit" name="submitButtonName" value="Update"/><input type="hidden" name="CUSTOMER_ID" value="<?php echo $row["CUSTOMER_ID"]?>"/></td>
        </tr>
    </table>
</form>
<?php
